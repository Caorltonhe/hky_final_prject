...
def main():
    ...
    for epoch in range(epochs):
        ...
        if val_accuracy.result() > best_val_acc:
            ...
            # model.save_weights("C:/桌面/college/大四上/project/flower_GoogleNet/save_weights/myGoogLeNet.ckpt") # epochs=30
            # model.save_weights("C:/桌面/college/大四上/project/flower_GoogleNet/save_weights/myGoogLeNet.ckpt2") # epochs=25
            model.save_weights("C:/桌面/college/大四上/project/flower_GoogleNet/save_weights/myGoogLeNet.ckpt30")  # epochs=35

        # plot
    epochs_range = range(epochs)  # creating a sequence of number from 0 to 40
